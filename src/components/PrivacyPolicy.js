        ...
        <div className="p-6 text-gray-300 space-y-6">
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="bg-gray-700/50 rounded-lg p-3">
                ...
                <p>We collect the financial information you voluntarily enter into The Freedom Compass App (income, expenses, assets, etc.). This is your data. You are the sole operator of it.</p>
              </div>
              <div className="bg-gray-700/50 rounded-lg p-3">
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc list-inside">
              <li>To provide and maintain the core services of The Freedom Compass App.</li>
