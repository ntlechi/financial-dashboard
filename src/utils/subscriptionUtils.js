...
export const FEATURE_ACCESS = {
  ...
  'field-notes-missions': [SUBSCRIPTION_TIERS.FREE, SUBSCRIPTION_TIERS.CLIMBER, SUBSCRIPTION_TIERS.OPERATOR, SUBSCRIPTION_TIERS.FOUNDERS_CIRCLE, SUBSCRIPTION_TIERS.EARLY_ADOPTER], // Free = read-only missions
