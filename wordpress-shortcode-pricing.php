...
function survive_pricing_shortcode($atts) {
    ...
    $atts = shortcode_atts(array(
        'phase' => '1', // 1, 2, or 3
        'spots' => '25' // Number of spots claimed
    ), $atts);
...
function get_founders_circle_html($spots) {
    ob_start();
    ?>
    <div id="survive-pricing-container" style="background-color: #111827; color: #f3f4f6; min-height: 100vh; padding: 2rem 1rem;">
        <div style="max-width: 1200px; margin: 0 auto;">
            ...
            <div style="text-align: center; margin-bottom: 4rem;">
                ...
                <p style="font-size: 1.25rem; color: #9ca3af; margin-bottom: 2.5rem;">Join thousands of adventurers who are taking control of their financial future.</p>
