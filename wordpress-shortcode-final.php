...
function get_founders_circle_html($spots) {
    ob_start();
    ?>
    <div id="survive-pricing-container" style="background-color: #111827; color: #f3f4f6; min-height: 100vh; padding: 2rem 1rem; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
